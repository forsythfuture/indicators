...
aa_married_below<-filter(aa,  description=='Estimate; Income in the past 12 months below poverty level: - Other family: - Male householder, no wife present: - With related children of the householder under 18 years:'|description=='Estimate; Income in the past 12 months below poverty level: - Other family: - Male householder, no wife present: - With related children of the householder under 18 years'|description=='Estimate; Income in the past 12 months below poverty level: - Married-couple family: - With related children under 18 years:')
...
#################################################################################################################
MOE_Renter=Proportion_MOE(aa_total[,4], Total[,4], Renter[,5],Renter[,11])
test=Proportion_MOE(aa_total[,4],aa_total[,5], aa_female_above[,4], aa_female_above[,9])
```
