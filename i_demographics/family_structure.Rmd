...
rm(location,year,description,type,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
###############################################
location<-rep("Forsyth County", each=11)
...
white_married<-cbind(location,year,description,type,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
rm(location,year,description,type,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
###############################################
location<-rep("Forsyth County", each=12)
...
cv<-rename(cv,cv_proportion="above&below")
race<-rep('White',each=12)
white_female<-cbind(location,year,description,type,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
rm(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
...
hl_married<-cbind(location,year,description,type,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
rm(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
###############################################
location<-rep("Forsyth County", each=2)
...
cv<-rename(cv,cv_proportion="above&below")
race<-rep('White',each=2)
hl_female<-cbind(location,year,description,type,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
rm(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
...
year<-df%>%
  ...
  ggplot(year, aes(type, percentage, fill = race)) +
...
*Hispanic family structure's are not included in this data because the data was not collected for hispanic families in 2017.
...
year<-df%>%
  ...
  filter(
    str_detect(year, '2017'))
  ggplot(year, aes(race, percentage, fill = type)) +
    geom_bar(position='dodge',stat = "identity") +
...
```{r}
  ggplot(df, aes(year, percentage, color = type)) +
    geom_line(size = 1) +
