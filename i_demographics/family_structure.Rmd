...
above_below_moe<-rename(above_below_moe,above_below_moe=above_moe)
above_below_se<-se_function(above_below_moe)
above_below_se<-rename(above_below_se,above_below_se=above_below_moe)
percentage<-above_below[,1]/aa_total[,4]
percentage<-rename(percentage, percentage = estimate)
moe_percentage<-moe_proportion(above_below_moe,aa_total[,5],percentage,aa_total[,4])
moe_percentage<-rename(moe_percentage, moe_percentage =above_below_moe)
se<-se_proportion(above_below_se,percentage,aa_total[,6],aa_total[,4])
se<-rename(se,se_proportion=above_below_se)
cv<-cv_function(above_below)
cv<-rename(cv,cv_proportion="above&below")
...
###############################################
location<-rep("Forsyth County", each=11)
type<-rep('female',each=11)
year<-aa_female_above[,2]
description<-rep("Female householder, no husband present: with related children of the householder under 18 years", each=11)
...
above<-aa_male_above[,4]
above<-rename(above,above=estimate)
below<-aa_male_below[,4]
below<-rename(below,below=estimate)
above_below<-aa_male_above[,4]+aa_male_below[,4]
above_below<-rename(above_below,'above&below'=estimate)
above_moe<-aa_male_above[,5]
above_moe<-rename(above_moe,above_moe=moe)
below_moe<-aa_male_below[,5]
below_moe<-rename(below_moe,below_moe=moe)
above_below_moe<-moe_function(above_moe,below_moe)
above_below_moe<-rename(above_below_moe,above_below_moe=above_moe)
above_below_se<-se_function(above_below_moe)
...
cv<-rename(cv,cv_proportion="above&below")
race<-rep('African American',each=11)
aa_male<-cbind(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
rm(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
###############################################
#########################################################################################################
...
year<-white_married_above[,12]
type<-rep('married',each=12)
description<-rep("Married-couple family with related children of the householder under 18 years", each=12)
above<-white_married_above[,4]
above<-rename(above,above=estimate)
below<-white_married_below[,4]
below<-rename(below,below=estimate)
above_below<-white_married_above[,4]+white_married_below[,4]
above_below<-rename(above_below,'above&below'=estimate)
above_moe<-white_married_above[,5]
above_moe<-rename(above_moe,above_moe=moe)
below_moe<-white_married_below[,5]
below_moe<-rename(below_moe,below_moe=moe)
above_below_moe<-moe_function(above_moe,below_moe)
above_below_moe<-rename(above_below_moe,above_below_moe=above_moe)
above_below_se<-se_function(above_below_moe)
above_below_se<-rename(above_below_se,above_below_se=above_below_moe)
percentage<-above_below[,1]/white_total[,4]
percentage<-rename(percentage, percentage = estimate)
moe_percentage<-moe_proportion(above_below_moe,white_total[,5],percentage,white_total[,4])
moe_percentage<-rename(moe_percentage, moe_percentage =above_below_moe)
se<-se_proportion(above_below_se,percentage,white_total[,6],white_total[,4])
se<-rename(se,se_proportion=above_below_se)
cv<-cv_function(above_below)
cv<-rename(cv,cv_proportion="above&below")
race<-rep('White',each=12)
white_married<-cbind(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
rm(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
###############################################
location<-rep("Forsyth County", each=12)
type<-rep("female", each=12)
year<-white_female_above[,2]
description<-rep("Female householder, no husband present: with related children of the householder under 18 years", each=12)
above<-white_female_above[,4]
above<-rename(above,above=estimate)
below<-white_female_below[,4]
below<-rename(below,below=estimate)
above_below<-white_female_above[,4]+white_female_below[,4]
above_below<-rename(above_below,'above&below'=estimate)
above_moe<-white_female_above[,5]
above_moe<-rename(above_moe,above_moe=moe)
below_moe<-white_female_below[,5]
below_moe<-rename(below_moe,below_moe=moe)
above_below_moe<-moe_function(above_moe,below_moe)
above_below_moe<-rename(above_below_moe,above_below_moe=above_moe)
above_below_se<-se_function(above_below_moe)
...
cv<-rename(cv,cv_proportion="above&below")
race<-rep('White',each=12)
white_female<-cbind(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
rm(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)

#########################################################################################################
location<-rep("Forsyth County", each=12)
type<-rep('male',each=12)
...
above<-white_male_above[,4]
above<-rename(above,above=estimate)
below<-white_male_below[,4]
below<-rename(below,below=estimate)
above_below<-white_male_above[,4]+white_male_below[,4]
above_below<-rename(above_below,'above&below'=estimate)
above_moe<-white_male_above[,5]
above_moe<-rename(above_moe,above_moe=moe)
below_moe<-white_male_below[,5]
below_moe<-rename(below_moe,below_moe=moe)
above_below_moe<-moe_function(above_moe,below_moe)
above_below_moe<-rename(above_below_moe,above_below_moe=above_moe)
above_below_se<-se_function(above_below_moe)
...
cv<-rename(cv,cv_proportion="above&below")
race<-rep('White',each=12)
white_male<-cbind(location,year,description,type,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
rm(type,location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
###############################################HISPANIC###########################################################################
df <- read_csv('data/family_structure_all_years.csv') %>%
  filter(geo_description %in% geo_areas) %>%
  select(-label)
...
type<-rep('married',each=2)
description<-rep("Married-couple family with related children of the householder under 18 years", each=2)
above<-hl_married_above[,4]
above<-rename(above,above=estimate)
below<-hl_married_below[,4]
below<-rename(below,below=estimate)
above_below<-hl_married_above[,4]+hl_married_below[,4]
above_below<-rename(above_below,'above&below'=estimate)
above_moe<-hl_married_above[,5]
above_moe<-rename(above_moe,above_moe=moe)
below_moe<-hl_married_below[,5]
below_moe<-rename(below_moe,below_moe=moe)
above_below_moe<-moe_function(above_moe,below_moe)
above_below_moe<-rename(above_below_moe,above_below_moe=above_moe)
above_below_se<-se_function(above_below_moe)
above_below_se<-rename(above_below_se,above_below_se=above_below_moe)
percentage<-above_below[,1]/hl_total[,4]
percentage<-rename(percentage, percentage = estimate)
moe_percentage<-moe_proportion(above_below_moe,hl_total[,5],percentage,hl_total[,4])
moe_percentage<-rename(moe_percentage, moe_percentage =above_below_moe)
se<-se_proportion(above_below_se,percentage,hl_total[,6],hl_total[,4])
se<-rename(se,se_proportion=above_below_se)
cv<-cv_function(above_below)
cv<-rename(cv,cv_proportion="above&below")
race<-rep('White',each=2)
hl_married<-cbind(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
rm(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
###############################################
location<-rep("Forsyth County", each=2)
type<-rep("female", each=2)
...
above<-hl_female_above[,4]
above<-rename(above,above=estimate)
below<-hl_female_below[,4]
below<-rename(below,below=estimate)
above_below<-hl_female_above[,4]+hl_female_below[,4]
above_below<-rename(above_below,'above&below'=estimate)
above_moe<-hl_female_above[,5]
above_moe<-rename(above_moe,above_moe=moe)
below_moe<-hl_female_below[,5]
below_moe<-rename(below_moe,below_moe=moe)
above_below_moe<-moe_function(above_moe,below_moe)
above_below_moe<-rename(above_below_moe,above_below_moe=above_moe)
above_below_se<-se_function(above_below_moe)
...
cv<-rename(cv,cv_proportion="above&below")
race<-rep('White',each=2)
hl_female<-cbind(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
rm(location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)

#########################################################################################################
location<-rep("Forsyth County", each=2)
type<-rep('male',each=2)
...
above<-hl_male_above[,4]
above<-rename(above,above=estimate)
below<-hl_male_below[,4]
below<-rename(below,below=estimate)
above_below<-hl_male_above[,4]+hl_male_below[,4]
above_below<-rename(above_below,'above&below'=estimate)
above_moe<-hl_male_above[,5]
above_moe<-rename(above_moe,above_moe=moe)
below_moe<-hl_male_below[,5]
below_moe<-rename(below_moe,below_moe=moe)
above_below_moe<-moe_function(above_moe,below_moe)
above_below_moe<-rename(above_below_moe,above_below_moe=above_moe)
above_below_se<-se_function(above_below_moe)
...
cv<-rename(cv,cv_proportion="above&below")
race<-rep('White',each=2)
hl_male<-cbind(location,year,description,type,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
rm(type,location,year,description,percentage,above_below,above_below_moe,above_below_se,moe_percentage,se,cv,race)
```
...
female<-df%>%
  ...
  filter(
    str_detect(description, 'Female householder, no husband present: with related children of the householder under 18 year'))
male<-df%>%
  # only keep total poverty rate
  filter(
    str_detect(description, 'Male householder, no wife present: with related children of the householder under 18 year'))
married<-df%>%
  # only keep total poverty rate
  filter(
    str_detect(description, 'Married-couple family with related children of the householder under 18 years'))
  ggplot(df, aes(type, percentage, fill = race)) +
    geom_bar(stat = "identity", position_dodge()) +
    labs(title = 'Family Structure by Race',
         color = "Race",
         y = 'Poverty rate (%)') 
```
