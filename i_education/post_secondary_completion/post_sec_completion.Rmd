...
```{r}
post_sec <- read_csv('data/edu_made.csv')
...
df %>%
  ...
  filter(age=='2599',race_eth=='ALL',gender=='ALL', geography!='US') %>%
...
total_data <- df %>%
  ...
  filter(geography != 'US', age=='2599', race_eth=='ALL', gender=='ALL') %>%
...
ethnicity_bar <- df %>%
filter((geography!='US' & age=='2599'& race_eth=="White, non-Hispanic" & gender=='ALL' & year == max(.$year))|(geography!='US' & age=='2599'& race_eth=='Latinx' & gender=='ALL' & year == max(.$year))|(geography!='US' & age=='2599'& race_eth=='African American' & gender=='ALL' & year == max(.$year)))
...
age <- df %>%
        filter((geography!='US' & age=='2534'& race_eth=='ALL' & gender=='ALL')|(geography!='US' & age=='3544'& race_eth=='ALL' & gender=='ALL')|(geography!='US' & age=='4564'& race_eth=='ALL' & gender=='ALL')|(geography!='US' & age=='6599'& race_eth=='ALL' & gender=='ALL'))
...
gender <- df %>%
        filter((geography!= 'US' & age=='2599'& race_eth=='ALL' & gender=='female')|(geography!='US' & age=='2599'& race_eth=='ALL' & gender=='male'))
