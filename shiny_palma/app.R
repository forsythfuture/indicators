...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    selectInput("demographic", label = "Geographic unit:",
                choices = unique_demo,
...
server <- function(input, output, session) { 
  ...
  #   
  #   checkboxGroupInput('demo_check', 'Geography:', unique(df$type), selected = unique(df$type), inline = TRUE)
  #   
  # })
