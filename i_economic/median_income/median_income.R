...
file_folder = 'i_economic/median_income/data'

unzip_files('zip_files/median_income.zip', file_folder)
...
write_csv(emp, paste0(file_folder, '/', 'median_income_all_years_counties.csv'))
