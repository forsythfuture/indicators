...
* Forsyth County also has the highest disparity between White and Hispanic/Latinx median incomes. However, the differences between Forsyth County and Guilford and Durham counties are not statistically significant.
* Within Forsyth County, the White to African American disparity and White to Hispanic/Latinx disparity are similar. In fact, in no years is the difference statistically significant.
* The White to African American disparity and White to Hispanic/Latinx disparity both increased in 2017 in Forsyth County. But, only the White to African American increase is statistically significant.
...
* Forsyth County's gender income disparity was lower than the US and North Carolina average every year. This difference is statistically significant for all years except in 2009 and 2017.
* Forsyth County has experienced an increase in gender income disparity over the past two years, but the increase is not statistically significant.
...
tableau_data %>%
  ...
  # create table
  ff_data_dt(c('Year', 'Geographic area', 'Type', 'Subtype', 'Median income ratio'), for_tableau=TRUE)
```