...
The poverty rate reflects the percentage of the population in poverty. The data for poverty rates comes American Fact Finder table S1701. 
...
tableau_data %>%
  ...
  # create table
  ff_data_dt(c('Year', 'Geographic area', 'Type', 'Subtype', 'Percent Employed'), for_tableau=TRUE)
```