...
ethnicity %>%
  ...
  ff_acs_zscore_kable(paste0('Z-scores by ethnicity', ' in ', paste(ethnicity_years, collapse = ' and ')))
```
...
age %>%
  ...
  ff_acs_zscore('perc_employed', 'perc_employed_moe', c('year', 'geo_description', 'age'))  %>%
...
gender %>%
  ...
  ff_acs_zscore('estimate', 'moe', c('year', 'geo_description', 'gender'))  %>%
  ff_acs_zscore_kable(paste0('Z-scores by gender', ' in ', paste(gender_years, collapse = ' and ')))
```
...
gender %>%
  ...
  ff_acs_zscore_kable(paste0('Forsyth County z-scores by gender'))
```
