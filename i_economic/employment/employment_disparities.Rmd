...
### Employment rate disparities by race and ethnicity

Disparities by ethnicity reflect ratios between white employment rates and african american or hispanic rates.
...
gender_ratios <- df %>%
  ...
  # calculate male / femal ratio
  ff_ratios_gender(years, geo_areas)
```
